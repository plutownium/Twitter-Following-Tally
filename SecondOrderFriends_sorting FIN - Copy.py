...
CONSUMER_KEY = # <removed for public posting> 
CONSUMER_SECRET = # <removed for public posting>

my_screen_name = # <removed for public posting>
my_id = # <removed for public posting>
